class Recipe:
    ...
    def __init__(self, name, ingredients, instructions, url):
        ...
        self.__author = "N/A"
        self.__rating = -1
        self.__star_rating = -1
        self.__ratings = -1
        self.__ingredients = ingredients
        self.__instructions = instructions
        self.__time_to_prepare = -1
        self.__string_time = "N/A"
        self.__serving_size = -1
        self.__servings = -1
        self.url = url
        self.source_website = ""
    ...
    def set_rating(self, rating):
        ...
        self.__star_rating = round(rating * 5, 1)
    ...
    def get_prep_time(self):
        return self.__time_to_prepare

    def set_prep_time(self, time):
        self.__time_to_prepare = time

    def set_string_time(self, string_time):
        self.__string_time = string_time

    def get_string_time(self):
        return self.__string_time
